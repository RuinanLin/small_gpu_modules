...
nvcc -rdc=true -ccbin nvc++ -I/sw/spack/deltas11-2023-03/apps/linux-rhel8-zen/gcc-8.5.0/nvhpc-22.11-eionxjt/Linux_x86_64/22.11/comm_libs/nvshmem/include test_send_recv_buffer.cu -c -o test_send_recv_buffer.o
nvc++ test_send_recv_buffer.o -o test_send_recv_buffer.out -cuda -gpu=cc80 -L/sw/spack/deltas11-2023-03/apps/linux-rhel8-zen/gcc-8.5.0/nvhpc-22.11-eionxjt/Linux_x86_64/22.11/comm_libs/nvshmem/lib -L/u/rlin2/metis-5.1.0/build/Linux-x86_64/my_build/lib -lnvshmem_host -lnvshmem_device -lnvidia-ml -lcuda -lcudart -lmetis

srun --account=bcsh-delta-gpu --partition=gpuA100x4-interactive -G 4 -n 4 -N 1 --mem=240G ./test_send_recv_buffer.out
